...
class Ui_MainWindow(QWidget):    
    ...
    def setupUi(self):
        ...
        self.b1 = QCheckBox("Previous Image")
        self.b1.setChecked(False)
        self.b1.stateChanged.connect(self.previewImage)
    ...
    def previewImage(self):
        if self.b1.text()=="Previous Image":
            self.tempImg = self.image
            self.displayPhoto(self.origImg)
            self.b1.setText("back to normal")
        else:
            self.b1.setText("Previous Image")
